...
public class Cabinet {
	...
	public Cabinet(String startbutton, int ports,String brand, int register, String coolingfan, String processor, int diode, double price, String capacity, int speed  ,String brand1,double resolution,int size,
			double price1,String brand2,String type,double price3) {
		...
		kb=new Keyboard(brand2,type,price3);
